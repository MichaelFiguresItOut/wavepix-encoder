    ...
    const renderFrame = (timestamp: number) => {
      ...
      switch(settings.type) {
        ...
        case "wave":
          ...
          break;
        case "circle":
          drawCircle(ctx, dataArray, canvas, bufferLength, rotationAngleRef.current);
          break;
        case "line":
              ...
              {settings.type === "circle" && (
                <div className="space-y-2">
                  ...
                  <Slider 
                    ...
                    onValueChange={([value]) => setSettings({...settings, rotationSpeed: value})}
                  />
                </div>
              )}
            </div>
